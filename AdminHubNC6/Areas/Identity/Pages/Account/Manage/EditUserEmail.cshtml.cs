...
namespace AdminHubNC6.Areas.Identity.Pages.Account.Manage
{
    public class EditUserEmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            //Debug.WriteLine("OnPostChangeEmailAsync:");
            var email = await _userManager.GetEmailAsync(user);
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = _authLocalizer.GetLocalizedHtmlString("CONFIRM_LINK_CHANGE_EMAIL");
                //Debug.WriteLine("Email updated");
                //Debug.WriteLine(Input.selectedUid);
                return RedirectToPage("EditUserEmail", new { selectedUid = Input.selectedUid });
            }

            StatusMessage = _authLocalizer.GetLocalizedHtmlString("YOUR_EMAIL_IS_UNCHANGED");
            return RedirectToPage("EditUserEmail", new { selectedUid = Input.selectedUid });
        }
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = _authLocalizer.GetLocalizedHtmlString("STATUS_UPDATE_PROFILE_EMAIL_SEND");
